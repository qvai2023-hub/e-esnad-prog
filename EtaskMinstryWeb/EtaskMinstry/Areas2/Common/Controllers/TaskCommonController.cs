...
{
    public class TaskCommonController : BaseCommonController
    {
        private void FillDropDownLists()
        {
            ...
            ViewBag.Employee = new SelectList(ServiceManger.GetCompanyEmployeeNotDeleted(MvcApplication.userData.CompanyId.Value), "id", "name");
            ViewBag.Tasks = new SelectList(new TaskCommonVM().Select("", "", "", "", "", 0, 0, null, null, 0, 0), "TaskID", "Task");
        }


        public ActionResult SaveData(TaskAddEditCommon objTask)
        {
            FillDropDownLists();
        ...
        {
            bool isDublicated = new TaskAddEditCommon().CheckDublication(TaskID, Title);
        ...
        public ActionResult GetTask(int taskId)
        {
            ...
            var task = new TaskAddEditCommon().gettask(taskId);
