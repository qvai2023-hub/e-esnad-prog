...
namespace EtaskMinstry.Models.Employee
{
    public class DashBoardVM
    {
        ...
        [LocalizedDisplayName("taskName", NameResourceType = typeof(Resources.EmployeeTask))]
        public string taskName { get; set; }

        [LocalizedDisplayName("projectName", NameResourceType = typeof(Resources.EmployeeTask))]
        public string projectName { get; set; }

        [LocalizedDisplayName("priority", NameResourceType = typeof(Resources.EmployeeTask))]
        public string priority { get; set; }

        [LocalizedDisplayName("priority", NameResourceType = typeof(Resources.EmployeeTask))]
        public string rowColor { get; set; }

        [LocalizedDisplayName("state", NameResourceType = typeof(Resources.EmployeeTask))]
        public string state { get; set; }

        [LocalizedDisplayName("StartDate", NameResourceType = typeof(Resources.EmployeeTask))]
        ...
        [LocalizedDisplayName("EndDate", NameResourceType = typeof(Resources.EmployeeTask))]
        public DateTime? endDate { get; set; }

        [LocalizedDisplayName("isAccepted", NameResourceType = typeof(Resources.EmployeeTask))]
        public bool isAccepted { get; set; }

        public int? EmpID { get; set; }
        public Boolean IsDelayed { get; set; }
        public Boolean IsDeleted { get; set; }
        [LocalizedDisplayName("DelayTime", NameResourceType = typeof(Resources.EmployeeTask))]
        ...
        [LocalizedDisplayName("actualTime", NameResourceType = typeof(Resources.EmployeeTask))]
           ...
           int currentUser = MvcApplication.userData.isCompany ? 0 : MvcApplication.userData.userId;
            ...
            objTasks.ForEach(
                ...
                case DashBoaedTaskType.FinishToday:
                    ...
                    objTasks = _unitOfWork.TaskRepository.Get(t => t.EmpID == iEmpolyee && t.EndDate == DateNow && t.StatusID == (int)TaskStatus.Inprogress && !t.IsDeleted).Select(t => new DashBoardVM()
                    {
                        taskID = t.TaskID,
                        taskName = t.Title,
                        startDate = t.StartDate.HasValue ? t.StartDate.Value : new Nullable<DateTime>(),
           ...
           int iTasksCount  =0;
            switch (taskType)
            {
                ...
                case DashBoaedTaskType.FinishToday: //EndDate =today
                    ...
                    //   DateTime? MinusOneDay = DateTime.Now.AddDays(-1);
                    DateTime? DateNow = DateTime.Now.Date;
                    iTasksCount = _unitOfWork.TaskRepository.Get(t => t.EmpID == iEmpolyee && t.EndDate == DateNow && t.StatusID == (int)TaskStatus.Inprogress && !t.IsDeleted).Count();   
