...
$.extend(UmmAlQuraCalendar.prototype, {
	...
	regional: { // Localisations
		'': {
			...
			epochs: ['BH', 'AH'],
			monthNames: ['المحرم', 'صفر', 'ربيع\' الأول', 'ربيع\' الثانى', 'جمادى الأول', 'جمادى الثانى',
			'رجب', 'شعبان', 'رمضان', 'شوال', 'ذو القعدة', 'ذو الحجة'],
			monthNamesShort: ['مح', 'صف', 'ربيع1', 'ربيع2', 'جمادى1', 'جمادى2', 'رجب', 'شعب', 'رمض', 'شو', 'قعدة', 'حجة'],
			dayNames: ['يوم الأحد', 'يوم الأثنين', 'يوم الثلاثاء', 'يوم الاربعاء', 'يوم الخميس', 'يوم الجمعة', 'يوم السبت'],
			dayNamesMin: ['احد', 'اثنين', 'ثلاث', 'اربع', 'خميس', 'جمعة', 'سبت'],
