...
namespace EtaskMinstry.Models.Login
{
    public class Security
    {
        ...
        public bool? ForgetPawword(string Email)
        {
            ...
            //var emp = _unitOfWork.Employee.Get(e=>e.Email == Email).FirstOrDefault();
           // var emp = _unitOfWork.UserAccount.Get(e => e.UserName == Email).FirstOrDefault();
            ...
            if (emp != null)
            {
                //var password = QvLib.Security.DataProtection.Decrypt(emp.UserAccounts.FirstOrDefault().Password);
